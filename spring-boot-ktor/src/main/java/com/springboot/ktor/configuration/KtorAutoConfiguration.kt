...
import com.springboot.ktor.ApplicationX
import com.springboot.ktor.filter.Filter
import com.springboot.ktor.util.GsonUtil
    ...
    open fun applicationEngine(context: ApplicationContext): ApplicationEngine {
        ...
        return embeddedServer(engineFactory, properties.port, properties.host) {
            ...
            if (Class.forName("io.ktor.freemarker.FreeMarker") != null)
                install(FreeMarker) {
                    templateLoader = ClassTemplateLoader(ApplicationX::class.java, "/${properties.templatesRoot}")
                }
